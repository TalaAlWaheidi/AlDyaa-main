    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-description">
                Edit Delivary Man Information
            </p>
            <form class="forms-sample" method="POST" action="{{ route('delivaryman.update', $deliveryMan->id) }}">
                @csrf
                @method('PUT')
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="name" class="form-control" id="exampleInputUsername"
                            placeholder="Username" value="{{ $deliveryMan->name }}">
                    </div>
                </div>
                {{-- <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="phone" class="form-control" id="exampleInputMobile"
                            placeholder="Mobile number" value="{{ $deliveryMan->phone }}">
                    </div>
                </div>
                <div class=" form-group row">
                ...
                <div class=" form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="carnum" id="exampleInputCarNum"
                            placeholder="Car Number" value="{{ $deliveryMan->carnum }}">
                    </div>
                </div>
